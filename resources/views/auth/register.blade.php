...
<head>
    ...
    <title>Sign Up | {{ config('app.name', 'LearnApp') }}</title>
...
>
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            ...
            <!-- Form Section -->
            <div class="flex flex-col flex-1 w-full overflow-y-auto lg:w-1/2">
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="absolute right-0 top-0 -z-1 w-full max-w-[250px] xl:max-w-[450px]">
                        <svg width="450" height="450" viewBox="0 0 450 450" fill="none" xmlns="http://www.w3.org/2000/svg" class="opacity-20">
                            <rect width="450" height="450" fill="url(#grid-pattern-r)"/>
                            <defs>
                                <pattern id="grid-pattern-r" patternUnits="userSpaceOnUse" width="50" height="50">
                    ...
                    <div class="absolute bottom-0 left-0 -z-1 w-full max-w-[250px] rotate-180 xl:max-w-[450px]">
                        <svg width="450" height="450" viewBox="0 0 450 450" fill="none" xmlns="http://www.w3.org/2000/svg" class="opacity-20">
                            <rect width="450" height="450" fill="url(#grid-pattern-r2)"/>
                            <defs>
                                <pattern id="grid-pattern-r2" patternUnits="userSpaceOnUse" width="50" height="50">
                                    <path d="M 50 0 L 0 0 0 50" fill="none" stroke="rgba(255,255,255,0.1)" stroke-width="1"/>
                                </pattern>
                            </defs>
                        </svg>
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="/" class="block mb-4">
                            <h2 class="text-3xl font-bold text-white">{{ config('app.name', 'LearnApp') }}</h2>
                        </a>
