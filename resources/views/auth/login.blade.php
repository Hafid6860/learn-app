...
<head>
    ...
    <title>Sign In | {{ config('app.name', 'LearnApp') }}</title>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <label for="remember_me" class="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
                                            <input
                                                ...
                                                type="checkbox"
                                                name="remember"
                                                class="mr-3 h-5 w-5 rounded-md border-[1.25px] border-gray-300 text-brand-500 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-900"
                                            >
                                            Ingat saya
                                        </label>
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="absolute bottom-0 left-0 -z-1 w-full max-w-[250px] rotate-180 xl:max-w-[450px]">
                        <svg width="450" height="450" viewBox="0 0 450 450" fill="none" xmlns="http://www.w3.org/2000/svg" class="opacity-20">
                            <rect width="450" height="450" fill="url(#grid-pattern2)"/>
                            <defs>
                                <pattern id="grid-pattern2" patternUnits="userSpaceOnUse" width="50" height="50">
                                    <path d="M 50 0 L 0 0 0 50" fill="none" stroke="rgba(255,255,255,0.1)" stroke-width="1"/>
                                </pattern>
                            </defs>
                        </svg>
