...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | LearnApp</title>
...
<body class="bg-white dark:bg-gray-900">
    <div class="relative z-10 flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
        ...
        <div class="absolute -left-20 -top-20 h-72 w-72 rounded-full bg-brand-500/10 blur-3xl"></div>
        <div class="absolute -bottom-20 -right-20 h-72 w-72 rounded-full bg-brand-400/10 blur-3xl"></div>

        <div class="relative z-10 mx-auto w-full max-w-[472px] text-center">
            <h1 class="mb-8 text-4xl font-bold text-gray-800 dark:text-white/90 xl:text-6xl">ERROR</h1>

            <img src="/tailadmin/images/error/404.svg" alt="404" class="mx-auto dark:hidden" />
            <img src="/tailadmin/images/error/404-dark.svg" alt="404" class="mx-auto hidden dark:block" />
