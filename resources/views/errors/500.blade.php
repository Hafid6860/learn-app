...
<head>
    ...
    <title>500 - Kesalahan Server | LearnApp</title>
...
<body class="bg-white dark:bg-gray-900">
    <div class="relative z-10 flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
        ...
        <div class="absolute -left-20 -top-20 h-72 w-72 rounded-full bg-error-500/10 blur-3xl"></div>
        <div class="absolute -bottom-20 -right-20 h-72 w-72 rounded-full bg-error-400/10 blur-3xl"></div>

        <div class="relative z-10 mx-auto w-full max-w-[562px] text-center">
            <h1 class="mb-8 text-4xl font-bold text-gray-800 dark:text-white/90 xl:text-6xl">ERROR</h1>

            <img src="/tailadmin/images/error/500.svg" alt="500" class="mx-auto dark:hidden" />
            <img src="/tailadmin/images/error/500-dark.svg" alt="500" class="mx-auto hidden dark:block" />

            <p class="mb-6 mt-10 text-base text-gray-600 dark:text-gray-400 sm:text-lg">
                Terjadi kesalahan di server kami. Silakan coba lagi nanti! 🔧
            </p>
