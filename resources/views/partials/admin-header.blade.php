  ...
  >
    ...
    >
      ...
      <button
        ...
        class="z-999 flex h-10 w-10 items-center justify-center rounded-lg border-gray-200 text-gray-500 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
      ...
      <a href="{{ route('dashboard') }}" class="lg:hidden flex items-center gap-2">
        ...
        <span class="text-lg font-bold text-gray-800 dark:text-white">LearnApp</span>
      </a>
    ...
    >
      ...
      >
        ...
        >
          <span class="mr-3 flex h-11 w-11 items-center justify-center rounded-full bg-brand-500 text-white font-semibold text-sm">
        ...
        >
          ...
          <form method="POST" action="{{ route('logout') }}">
            ...
            <button
              type="submit"
              class="w-full group mt-3 flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              <svg
